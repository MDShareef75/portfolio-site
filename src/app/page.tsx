...
export default function Home() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Header Text */}
      <div className="absolute top-0 left-0 right-0 p-4 md:p-6 text-center z-20">
      ...
      <section className="container mx-auto px-4 py-8 md:py-0 flex items-center justify-center min-h-[calc(100vh-4rem)] relative">
